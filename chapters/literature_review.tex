...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        % Divide into tiers
        \coordinate (L1) at (-3.33, 2.33); % Approx 1/3 up
        \coordinate (R1) at (3.33, 2.33);
        \coordinate (L2) at (-1.66, 4.66); % Approx 2/3 up
        \coordinate (R2) at (1.66, 4.66);
        ...
        % Add text
        % Top Tier
        \node[align=center, text width=5cm] at (0, 5.5) {
            \textbf{Top Tier} \\
        ...
        % Middle Tier
        \node[align=center, text width=7cm] at (0, 3.5) {
            \textbf{Middle Tier} \\
        ...
        % Base Tier
        \node[align=center, text width=8cm] at (0, 1) {
            \textbf{Base Tier} \\
